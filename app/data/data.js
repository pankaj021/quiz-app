[
    {
        ...
        answers: [
            '<style>', '<script>', '<headStyle>', '<css>'
        ],
        correct: 1
    }, {
        question: 'Which HTML attribute is used to define inline styles?',
        answers: [
            'class', 'style', 'font', 'styles'
        ],
        correct: 2
    }, {
        ...
        answers: [
            'color', 'bgcolor', 'background-color', 'bgColor'
        ],
        correct: 3
    }, {
        question: 'How do you add a background color for all <h1> elements?',
        answers: [
            'all.h1 {background-color:#FFFFFF;}', 'h1.setAll {background-color:#FFFFFF;}', 'h1.all {background-color:#FFFFFF;}', 'h1 {background-color:#FFFFFF;}'
        ],
        correct: 4
    }
]